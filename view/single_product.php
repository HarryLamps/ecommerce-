...
?>
  ...
  <center>
    <div class="photo">
    <img style='height:200px;' src="../images/<?php echo $one_product['product_image']; ?>">
  </div>
  <div class="description">
    <h2><?php echo $one_product['product_title']; ?></h2>
    <!-- <h4>Popular House Plant</h4> -->
    <h1>GHS <?php echo $one_product['product_price']; ?> </h1>    
    <p><?php echo $one_product['product_desc']; ?></p>
    
    <p>Tags: <?php echo $one_product['product_keywords']; ?></p>
  ...
  <script>
    ...
    function fireSweetAlert() {
        Swal.fire(
            'Awesome!',
            'Added <?php echo $one_product['product_title']; ?> to cart',
            'success'
        )
    }
